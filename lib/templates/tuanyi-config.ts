...
export const tuanyiConfig: QuoterConfig = {
  ...
  name: "团体意外险报价器",
  title: "团体意外险报价器",
  description: "用于计算团体意外险保费，支持多职业类别配置",
  ...
  formulas: [
    ...
    },
    {
      ...
      dependencies: ["medicalDiscountCoef"],
      showInResult: false,
      unit: "元",
      arrayFormula: true,
    },
    ...
    },
    {
      ...
      dependencies: ["suddenDeathCoverage"],
      showInResult: false,
      unit: "元",
      arrayFormula: true,
    },
    ...
    },
    {
      id: "processPremium",
      name: "过程保费",
      description: "人数系数 × 投保人数 × 主险基准保费",
      expression: "@peopleCountCoef * $peopleCount * @baseMainPremium",
      dependencies: ["peopleCountCoef", "baseMainPremium"],
      showInResult: false,
      unit: "元",
      arrayFormula: true,
    },
    {
      ...
      name: "整体保费",
      description: "人数系数 × 投保人数 × (主险基准保费 × 职业人数系数) × 1.25",
      expression: "@peopleCountCoef * $peopleCount * (IF($peopleCount == 0, 0, @baseMainPremium * LOOKUP(occupationCoef, $occupation, '人数系数'))) * 1.25",
      dependencies: ["peopleCountCoef", "baseMainPremium"],
      showInResult: false,
      unit: "元",
      arrayFormula: true,
    },
    {
      ...
      expression: "IF($peopleCount == 0, 0, ROUND(@totalPremiumByOccupation / $peopleCount, 2))",
      dependencies: ["totalPremiumByOccupation"],
      showInResult: true,
      unit: "元",
      arrayFormula: true,
    },
    {
      ...
      expression: "ROUND((IF($drivingAmount, $drivingAmount, 0)) * 0.53 + (IF($busAmount, $busAmount, 0)) * 0.23 + (IF($railAmount, $railAmount, 0)) * 0.08 + (IF($shipAmount, $shipAmount, 0)) * 0.09 + (IF($flightAmount, $flightAmount, 0)) * 0.07 + (IF($ambulanceFee, $ambulanceFee, 0)) * 40, 2)",
      dependencies: [],
      showInResult: true,
      unit: "元",
      arrayFormula: true,
    ...
    },
    {
      id: "totalPremium",
      name: "总保费",
      description: "所有职业类别的总保费汇总",
      expression: "SUM(@careerTotalPremium)",
      dependencies: ["careerTotalPremium"],
      showInResult: true,
      unit: "元",
    },
  ],
